      ...
      map.on('mousemove', function(e) {
          ...
          if (msoa_hover.length > 0) {
            ...
            map.on('click', function(e) {
                var msoa_clicked = map.queryRenderedFeatures(e.point, {
                  layers: ['msoa']
                });
                if (msoa_clicked.length > 0) {
                  document.getElementById('msoa_name').innerHTML = '<strong>MSOA: </strong>' + msoa_clicked[0].properties.msoa11hclnm + '';
                  msoa_hover = null;
                } else {
